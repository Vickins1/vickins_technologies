...
const Footer: FC = () => {
  return (
    <footer className="bg-[var(--navbar-bg)] text-[var(--navbar-text)] py-12 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          ...
          >
            <h3 className="text-xl font-bold mb-4">Vickins Technologies</h3>
        ...
        <motion.div
          className="mt-8 pt-8 border-t border-[var(--navbar-text)]/20 text-center text-sm"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
